# Generated by Django 3.1.4 on 2021-04-14 14:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('Corpoarate Headoffice', 'Corpoarate Headoffice'), ('Operation department', 'Operation department'), ('Work Station', 'Work Station'), ('marketing division', 'marketing division')], default='Corpoarate Headoffice', max_length=30)),
                ...
                ('initial_severity', models.CharField(choices=[('Mild', 'Mild'), ('Moderate', 'Moderate'), ('Severe', 'Severe'), ('Fatel', 'Fatel')], default='Mild', max_length=30)),
